...
const ProjectAdminPage = () => {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-light-bg-primary dark:bg-dark-bg-primary">
        <div className="text-center">
          ...
          <p className="mt-4 text-sm font-medium text-light-text-secondary dark:text-dark-text-secondary">
            Loading admin page...
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-10 flex items-center justify-between gap-4 px-4 py-4 border-b border-light-border/60 dark:border-dark-border/60 bg-light-bg-primary/80 backdrop-blur-xl dark:bg-dark-bg-primary/80 sm:px-6">
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={handleBack}
            className="p-2 transition-all duration-150 rounded-xl text-light-text-secondary hover:bg-light-bg-hover hover:text-accent-primary active:scale-90 dark:text-dark-text-secondary dark:hover:bg-dark-bg-hover"
            aria-label="Back to project"
          >
            <ArrowLeftIcon className="w-5 h-5" />
          </button>
          <div>
            <h1 className="font-serif text-lg font-bold tracking-tight text-light-text-primary dark:text-dark-text-primary sm:text-xl">
            ...
            return (
              <button
                ...
                className={`relative flex items-center gap-2 whitespace-nowrap rounded-xl px-4 py-2.5 text-sm font-medium transition-all duration-200 ${
                  isActive
                    ? "bg-accent-primary/12 text-accent-primary shadow-sm ring-1 ring-accent-primary/20"
      ...
      >
        <div className="border shadow-sm rounded-2xl border-light-border/60 dark:border-dark-border/60 bg-light-bg-primary dark:bg-dark-bg-secondary">
