        ...
        <div className="glass rounded-xl p-4">
          <div className="flex items-center gap-3 mb-3">
            ...
            <button
              ...
              className={`btn-secondary ${showFilters || hasActiveFilters ? "bg-primary text-white" : ""}`}
            >
            ...
            {showFilters && (
              ...
              >
                <div className="flex items-center gap-3 pt-3 border-t border-border">
                  ...
                  {hasActiveFilters && (
                    <div className="pt-5">
                      <button onClick={clearFilters} className="btn-ghost text-sm text-error">
                        Clear All
                      </button>
                    </div>
                  )}
        ...
        >
          {searchTerm && (
            <span className="filter-pill">
              Search: "{searchTerm}"
              <button onClick={() => setSearchTerm("")} className="filter-pill-close">
                ×
              </button>
            </span>
          )}
          {filterPriority !== "all" && (
            <span className="filter-pill">
              ...
              <button onClick={() => setFilterPriority("all")} className="filter-pill-close">
                ×
              </button>
            </span>
          )}
          {filterAssignee !== "all" && (
            <span className="filter-pill">
              ...
              {
                // ✅ THIS IS THE FIX ✅
                members?.find((m) => m._id === filterAssignee)?.fullname || "Unknown"
              }
              <button onClick={() => setFilterAssignee("all")} className="filter-pill-close">
                ×
              </button>
            </span>
          )}
