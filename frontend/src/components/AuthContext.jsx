...
export const AuthProvider = ({ children }) => {
  ...
  const signup = useCallback(async (username, fullname, password, email, role, avatar) => {
    try {
      return await apiService.signup(username, fullname, password, email, role, avatar)
    } catch (error) {
  ...
  }, [user, loading, isAuthenticated, userID, login, logout, signup, resendVerifyEmail])
