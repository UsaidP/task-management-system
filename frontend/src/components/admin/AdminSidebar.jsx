    ...
    >
      <div className="flex h-16 items-center justify-between border-b border-light-border dark:border-dark-border px-4">
        ...
        <button
          ...
          className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-md text-light-text-tertiary hover:bg-light-bg-hover dark:hover:bg-dark-bg-hover hover:text-light-text-secondary"
        >
        ...
        {mainNav.map((item) => {
          ...
          return (
            ...
            >
              <Icon
                size={20}
                className="flex-shrink-0 text-light-text-tertiary group-hover:text-accent-primary"
              />
