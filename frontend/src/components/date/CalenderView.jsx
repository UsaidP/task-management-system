      ...
      <div className="w-full rounded-2xl bg-light-bg-secondary dark:bg-dark-bg-secondary shadow-sm p-6">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-light-text-primary dark:text-dark-text-primary">
            ...
            <span className="text-light-text-secondary dark:text-dark-text-secondary">{currentYear}</span>
          </h2>
        ...
        {!isLoading && !error && tasks.length === 0 && <EmptyState message="No tasks found for this month." />}
