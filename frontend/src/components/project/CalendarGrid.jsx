          ...
          <div className="grid grid-cols-7 min-w-[700px]">
            {calendarDaysData.map((item, index) => {
              ...
              return (
                <div
                  key={item.day}
                  className={`min-h-[80px] sm:min-h-[100px] p-1.5 sm:p-2 border-b border-r border-light-border dark:border-dark-border last:border-r-0 ${isToday ? "bg-accent-primary/10 dark:bg-accent-primary/20" : "hover:bg-light-bg-hover/50 dark:hover:bg-dark-bg-hover/50"}`}
                >
                  <div
