...
const Layout = ({ children }) => {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-bg-canvas selection:bg-accent-primary/20 selection:text-accent-primary">
      ...
      >
        <Header />
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-bg-canvas scrollbar-thin scrollbar-thumb-light-border dark:scrollbar-thumb-dark-border scrollbar-track-transparent">
