...
export const HeaderSkeleton = () => (
	<div className="flex items-center justify-between animate-pulse">
		...
		<div>
			...
			<div className="h-10 bg-gray-200 rounded-lg dark:bg-gray-700 w-64 mb-3"></div>

			{/* Mimics the "Here's what's happening..." p tag */}
			<div className="h-6 bg-gray-200 rounded-lg dark:bg-gray-700 w-80"></div>
		</div>

		{/* Right side of the header (date) */}
		{/* "hidden md:block" makes it responsive, hiding on small screens */}
		<div className="hidden md:block h-6 bg-gray-200 rounded-lg dark:bg-gray-700 w-48"></div>
	</div>
);
