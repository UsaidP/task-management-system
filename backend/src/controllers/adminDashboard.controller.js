...
// ─────────────────────────────────────────────────────────────────────────────
const getAdminWeeklyStats = asyncHandler(async (req, res) => {
  ...
  const createdMap = Object.fromEntries(
    dailyCreated.map((d) => [d._id, d.count]),
  )
  const completedMap = Object.fromEntries(
    dailyCompleted.map((d) => [d._id, d.count]),
  )
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, weeklyData, "Weekly stats fetched"))
})

// ─────────────────────────────────────────────────────────────────────────────
// 3. Get All Projects with Progress (for project progress widget)
// ─────────────────────────────────────────────────────────────────────────────
const getAdminProjectProgress = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(
      new ApiResponse(200, projectProgress, "Project progress fetched"),
    )
})
...
const getAdminAllUsers = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, usersWithStats, "All users fetched"))
})
...
// ─────────────────────────────────────────────────────────────────────────────
const getAdminTaskDistribution = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, result, "Task distribution fetched"))
})
